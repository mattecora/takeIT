<?php
	...
	$db = db_connect();
	$mentor = $db->query("SELECT * FROM mentor WHERE Mentor = '$_SESSION[user]'")->fetch_array();
	$db->close();
?>
	      ...
	      <div class="container"><!-- Brand and toggle get grouped for better mobile display -->
	        ...
	        <div class="collapse navbar-collapse main-nav" id="sept-main-nav">
	          <ul class="nav navbar-nav navbar-right">
							...
							<li class="active"><a href="mentor.php" class="profile-img-href"><img src="../photos/profile.png" style="height: 50px;"/></a></li>
	          </ul>
	        </div><!-- /.navbar-collapse -->
	      </div>
	    </nav>
	  ...
	  <section class="home midhome" id="home" data-stellar-background-ratio="0.4">
	    <div class="container">
	      <div class="row">
	        <div class="col-md-12">
	            <div class="hero-txt">
	              <h2 class="hero-title">Mentor info</h2>
	            </div>
	        </div>
	      </div>
	    </div>
